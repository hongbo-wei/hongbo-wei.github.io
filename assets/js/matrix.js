...
// Lazy-load audio after user interaction
const audio = document.getElementById("background-music");
const audioSrc = audio ? audio.dataset.src : null;
let audioLoaded = false;

function ensureAudioLoaded() {
    if (audio && !audioLoaded && audioSrc) {
        audio.src = audioSrc;
        audio.load();
        audioLoaded = true;
    }
...
// Start/pause music only after the first user interaction
document.body.addEventListener("click", togglePlay, { once: false });
