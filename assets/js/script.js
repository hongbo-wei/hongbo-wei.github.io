! function(t, e, i, n) {
    ...
    function u() {
        ...
        if (!n) return;
        var s = n.closest(".l-section.section");
        if (!s) return;
        var r = $(".main-content").children(),
            o = r.index(s);
        if (0 > o) return;
        var a = $(".side-nav").find(".is-active"),
            d = $(".side-nav").children().index(a),
            l = $(".side-nav").children().length - 1;
        e(o), i(d, o, l)
    }
    var o = !0,
        a = null,
        d = function(e) {
            if (!$(".outer-nav").hasClass("is-vis")) {
                ...
                var i = e.originalEvent || e,
                    n = i.wheelDelta ? -i.wheelDelta : i.deltaY ? i.deltaY : 20 * (i.detail || 0);
                n > 50 && o ? (o = !1, clearTimeout(a), a = setTimeout(function() {
                    o = !0
                }, 800), t(1)) : -50 > n && o && (o = !1, clearTimeout(a), a = setTimeout(function() {
                    o = !0
                }, 800), t(-1))
            }
        };
    document.addEventListener("wheel", d, {
        passive: !1
    }), document.addEventListener("mousewheel", d, {
        passive: !1
    }), document.addEventListener("DOMMouseScroll", d, {
        passive: !1
    ...
    }), n(), s(), r(), u(), $(window).on("hashchange", u)
});

// Lazy-load ClustrMaps only when the map is visible; fallback to iframe if it fails to render.
document.addEventListener("DOMContentLoaded", function() {
    var container = document.getElementById("clustrmap-container");
    if (!container) return;

    var scriptUrl = container.dataset.clustrSrc || "https://clustrmaps.com/globe.js?d=YgWdHCkJi9jii45ReF_lG6XfjkX6EY71WmJlCaYnpMs";
    var ensureGlobe = function() {
        var hasRender = container.querySelector("canvas, iframe");
        if (hasRender) return;
    ...
    var loadGlobeScript = function() {
        ...
        script.onload = function() {
            setTimeout(ensureGlobe, 1500);
        };
        script.onerror = ensureGlobe;
        container.appendChild(script);
        // Safety net if the script never paints
